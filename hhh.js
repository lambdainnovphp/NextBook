...
$(".addmore")["on"]("click", function() {
    ...
    html += '<td><input type="text" data-type="productName" name="data[Invoice][itemName][]" id="itemName_' + i + '" class="form-control autocomplete_txt" autocomplete="off"></td>';
    html += '<td><input type="text" data-type="productDesc" name="data[Invoice][itemDesc][]" id="itemDesc_'+i+'" class="form-control"></td>';
...
$(document)["on"]("focus", ".autocomplete_txt", function() {
    type = $(this)["data"]("type");
    if ("productCode" == type) autoTypeNo = 0;
    if ("productName" == type) autoTypeNo = 1;
    $(this)["autocomplete"]({
        source: function(a, b) {
            var c = $["map"](prices, function(a) {
                var b = a["split"]("|");
                return {
                    label: b[autoTypeNo],
                    value: b[autoTypeNo],
            ...
            b($["ui"]["autocomplete"]["filter"](c, a["term"]));
        },        
        autoFocus: true,
        minLength: 2,
        select: function(a, b) {
            var c = b["item"]["data"]["split"]("|");
            id_arr = $(this)["attr"]("id");
            id = id_arr["split"]("_");
            element_id = id[id["length"] - 1];
            $("#itemNo_" + element_id)["val"](c[0]);
            $("#itemName_" + element_id)["val"](c[1]);
            $("#quantity_" + element_id)["val"](1);
            $("#price_" + element_id)["val"](c[2]);
            $("#total_" + element_id)["val"](1 * c[2]);
            calculateTotal();
        }
    });
});
...
function IsNumeric(a) {	
    ...
    console["log"](b);
    var c = (b >= 48 && b <= 57) || specialKeys["indexOf"](b) != -1;    
    return c;
}
